...
In the xref:console.adoc[Console] admin UI, `/console/memory` runs review, curation and a full purge, and `/console/schedule` runs any of the jobs on demand. The scoped purges (`?source=`, `?includeJournals=`) are API-only.
