...
* xref:memory.adoc[Memory] - Declarative memory, injected every turn and searchable on demand
* xref:skills.adoc[Skills] - Procedural memory the agent writes and curates itself
* xref:storage.adoc[Storage] - Markdown, pgvector or hybrid, and how to move between them
...
* xref:secrets.adoc[Secrets] - An encrypted keystore instead of plain environment variables
...
* xref:operations.adoc[Operations] - Probes, readiness checks and cost estimation
